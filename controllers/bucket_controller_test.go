...
func TestBucketReconciler_reconcileSource(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			assertArtifact: sourcev1.Artifact{
				Path:     "bucket/test-bucket/a94a8fe5ccb19ba61c4c0873d391e987982fbbd3.tar.gz",
		...
		},
		{
			...
			assertArtifact: sourcev1.Artifact{
				Path:     "bucket/test-bucket/674ba440d1a2f659217b3be7925a023b240fe48b.tar.gz",
				Revision: "674ba440d1a2f659217b3be7925a023b240fe48b",
			},
			assertConditions: []metav1.Condition{
				*conditions.TrueCondition(sourcev1.SourceAvailableCondition, sourcev1.BucketOperationSucceedReason, "Downloaded 1 objects from bucket"),
			},
