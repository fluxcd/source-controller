...
func TestBucketReconciler_extractURLs(t *testing.T) {
...
func TestBucketReconciler_removeQueryString(t *testing.T) {
...
func TestBucketReconciler_sanitizeErrorMessage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			errMessage := sanitizeErrorMessage(tt.errMessage)

			g.Expect(errMessage).To(Equal(tt.wantErrMessage))
		})
	}
}
