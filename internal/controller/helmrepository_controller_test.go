...
func TestHelmRepositoryReconciler_reconcileStorage(t *testing.T) {
	tests := []struct {
		name             string
		beforeFunc       func(obj *qhelm.HelmRepository, storage *Storage) error
...
func TestHelmRepositoryReconciler_reconcileSource(t *testing.T) {
	...
	tests := []struct {
		...
		beforeFunc       func(t *WithT, obj *qhelm.HelmRepository, rev digest.Digest)
		afterFunc        func(t *WithT, obj *qhelm.HelmRepository, artifact sourcev1.Artifact, chartRepo *repository.ChartRepository)
		want             sreconcile.Result
		wantErr          bool
		assertConditions []metav1.Condition
	}{
...
func TestHelmRepositoryReconciler_reconcileArtifact(t *testing.T) {
	tests := []struct {
		name             string
		cache            *cache.Cache
		beforeFunc       func(t *WithT, obj *qhelm.HelmRepository, artifact sourcev1.Artifact, index *repository.ChartRepository)
		afterFunc        func(t *WithT, obj *qhelm.HelmRepository, cache *cache.Cache)
		want             sreconcile.Result
		wantErr          bool
		assertConditions []metav1.Condition
	}{
		...
		},
		{
			...
			afterFunc: func(t *WithT, obj *qhelm.HelmRepository, _ *cache.Cache) {
...
func TestHelmRepositoryReconciler_reconcileSubRecs(t *testing.T) {
	...
	buildReconcileFuncs := func(r sreconcile.Result, e error) helmRepositoryReconcileFunc {
		return func(ctx context.Context, sp *patch.SerialPatcher, obj *qhelm.HelmRepository, artifact *sourcev1.Artifact, repo *repository.ChartRepository) (sreconcile.Result, error) {
			return r, e
		}
	}
	...
	tests := []struct {
		...
		},
		{
			...
			reconcileFuncs: []helmRepositoryReconcileFunc{
				func(ctx context.Context, sp *patch.SerialPatcher, obj *qhelm.HelmRepository, artifact *sourcev1.Artifact, repo *repository.ChartRepository) (sreconcile.Result, error) {
...
func TestHelmRepositoryReconciler_statusConditions(t *testing.T) {
	tests := []struct {
		name             string
		beforeFunc       func(obj *qhelm.HelmRepository)
		assertConditions []metav1.Condition
	}{
		{
...
func TestHelmRepositoryReconciler_notify(t *testing.T) {
	...
	tests := []struct {
		...
		resErr           error
		oldObjBeforeFunc func(obj *qhelm.HelmRepository)
		newObjBeforeFunc func(obj *qhelm.HelmRepository)
		wantEvent        string
	}{
		{
			name:   "error - no event",
