...
// Temporary fork whilst the PR that adds If-Modified-Since is merged.
// xref: https://github.com/helm/helm/pull/10916
replace helm.sh/helm/v3 => github.com/pjbgf/helm/v3 v3.8.2-if-modified-since
